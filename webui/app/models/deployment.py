...
DEPLOYMENT_STEPS = [
    ...
    DeploymentStep(id=11, name="deploy_harbor", description="Deploy Harbor Registry"),
    DeploymentStep(id=12, name="deploy_build_vm", description="Deploy Build VM"),
    DeploymentStep(id=13, name="mirror_greenbone_images", description="Mirror Greenbone Images to Harbor"),
    DeploymentStep(id=14, name="deploy_openvas", description="Deploy OpenVAS"),
    DeploymentStep(id=15, name="deploy_faraday", description="Deploy Faraday"),
    DeploymentStep(id=16, name="deploy_metasploit", description="Deploy Metasploit"),
    DeploymentStep(id=17, name="deploy_threat_dragon", description="Deploy Threat Dragon"),
    DeploymentStep(id=18, name="configure_integrations", description="Configure Integrations"),
    DeploymentStep(id=19, name="generate_secrets", description="Generate & Apply Secrets"),
    DeploymentStep(id=20, name="commit_push_secrets", description="Commit & Push Secrets"),
    DeploymentStep(id=21, name="prepare_vulhub_targets", description="Prepare Vulhub Target Environments"),
    DeploymentStep(id=22, name="build_push_images", description="Build & Push Container Images"),
    DeploymentStep(id=23, name="deploy_cleanroom_apps", description="Deploy CleanRoom Applications"),
    DeploymentStep(id=24, name="deploy_console_routing", description="Deploy Deployment Console Routing"),
    DeploymentStep(id=25, name="apply_network_policies", description="Apply Network Policies"),
]
