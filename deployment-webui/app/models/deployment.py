...
DEPLOYMENT_STEPS = [
    ...
    DeploymentStep(id=7, name="install_argocd", description="Install ArgoCD & Configure Password"),
    DeploymentStep(id=8, name="deploy_infrastructure", description="Deploy Infrastructure Stack"),
    DeploymentStep(id=9, name="wait_for_longhorn", description="Wait for Longhorn Storage"),
