...
# All values in seconds. Use ${VAR:-default} pattern
# so callers can override before sourcing this file.
#######################################
TIMEOUT_SHORT=${TIMEOUT_SHORT:-60}
TIMEOUT_MEDIUM=${TIMEOUT_MEDIUM:-300}
TIMEOUT_LONG=${TIMEOUT_LONG:-900}
RETRY_INTERVAL_DEFAULT=${RETRY_INTERVAL_DEFAULT:-10}
