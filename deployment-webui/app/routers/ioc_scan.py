...
# =============================================================================
# WebSocket Connection Manager (IOC scan-specific)
# =============================================================================

class IocScanConnectionManager:
    """Manages WebSocket connections for IOC scan updates."""
...
ioc_manager = IocScanConnectionManager()
